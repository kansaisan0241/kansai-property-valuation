...
export default function Home() {
  ...
  const detailMansionName = mansionName.replace(/\r?\n/g, "");
  const detailEditors = type === "land" ? [
    ...
    <DetailEditor key="address" icon="⌖" label="所在地" type="textarea" value={detailAddress} onChange={(value) => setAddress(value.replace(/\r?\n/g, ""))} />,
    <DetailEditor key="mansion" icon="⌂" label="マンション名" type="textarea" value={detailMansionName} onChange={(value) => setMansionName(value.replace(/\r?\n/g, ""))} />,
