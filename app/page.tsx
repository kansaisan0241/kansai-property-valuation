  ...
  return <main>
    ...
    <div className="report-stack">
      ...
      <article id="page-strategy" className="report-page strategy-page">
        ...
        <section className="price-strategy"><h3>価格戦略のイメージ</h3><p>ご希望に合わせて、以下の3つの価格戦略をご提案いたします。</p><div className="strategy-cards"><div className="strategy-card"><h4>SPEED<small>スピード売却価格</small></h4><strong>{formatNumber(speed)}<small>万円</small></strong><p>市場に売却を完了したい方向けのスピード重視戦略</p><ul><li>早期成約が期待できる</li><li>販売期間：短期での成約を目指す</li><li>早く現金化したい方向け</li></ul></div><div className="strategy-card recommended-card"><em>おすすめ</em><h4>RECOMMEND<small>推奨売出価格</small></h4><strong>{formatNumber(recommended)}<small>万円</small></strong><p>市場での競争力と成約までの期間を考慮した価格</p><ul><li>成約の可能性が最も高い価格帯</li><li>適正な期間での成約が期待できる</li><li>価格とスピードのバランス重視</li></ul></div><div className="strategy-card"><h4>CHALLENGE<small>チャレンジ価格</small></h4><strong>{formatNumber(challenge)}<small>万円</small></strong><p>相場より高めの価格から市場の反応を確認する戦略</p><ul><li>高値での成約を目指す</li><li>販売期間：やや長期化の可能性</li><li>できるだけ高く売りたい方向け</li></ul></div></div></section>
